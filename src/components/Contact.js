      ...
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row lg:gap-x-[100px]'>
          <div className='flex-1 flex flex-col justify-end'>
            ...
            <div className='subtitle flex flex-col lg:flex-row'>We speak the following languages: <div className='text-violet-700 lg:mx-1'>Français, English.</div>Please contact us in these languages.</div>
              ...
              <div className='flex flex-col lg:flex-row lg:gap-20 mb-10'>
                <div className='flex flex-col mb-5'>
                  ...
                  <div className='flex flex-row items-center'>
                    ...
                    <input onChange={(e) => {setFirstname(e.target.value);}} type='text' className='border p-2 rounded-r-xl' placeholder='Firstname ...' />
                  </div>
                </div>
                <div className='flex flex-col'>
                  <div className='flex flex-row'>
                    <h2 className='text-xl mb-2'>Lastname:</h2>
                    <div className='text-red-500 ml-2'>*</div>
                  </div>
                  <div className='flex flex-row items-center'>
                    <div className='border-y border-l p-3 rounded-l-xl'><img alt='' className='w-5' src={user_img} /></div>
                    <input onChange={(e) => {setLastname(e.target.value);}} type='text' className='border p-2 rounded-r-xl' placeholder='Lastname ...' />
                  </div>
                </div>
              </div>
              <div className='mb-10'>
                ...
                <div className='flex flex-row items-center'>
                  ...
                  <input onChange={(e) => {setEmail(e.target.value);}} type='email' className='border p-2 lg:w-[400px] rounded-r-xl' placeholder='Email ...' />
                </div>
              </div>
              <div>
                <div className='flex flex-row'>
